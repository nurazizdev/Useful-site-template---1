...
output:
  html_document:
    css:
    - "~/Repository/repository/css/make-cv-like-other.css"
    - "~/Repository/repository/css/one-column-cv.css"
    - "~/Repository/repository/css/website-page.css"
    - "~/Repository/repository/css/style.css"
